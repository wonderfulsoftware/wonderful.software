...
และเราจะนำความรู้เหล่านี้มาสร้างเป็น**มินิโปรเจกต์**ต่างๆ
มินิโปรเจกต์ คือโปรเจกต์ขนาดเล็กๆ ใช้เวลาทำไม่นาน ที่เราจะได้นำความรู้ต่างๆ มาประกอบกัน เพื่อใช้งานจริงดู
...
เสร็จแล้วเราจะมาสร้างมินิโปรเจกต์ชิ้นต่อไป คือ**โปรแกรมควิซอย่างง่าย** (Simple Quiz)
...
ซึ่งในโปรเจกต์นี้เราจะได้เรียนรู้กับคำสั่งที่ใช้ในการสุ่มเลข
...
ในโปรเจกต์นี้เราจะได้รู้จักกับโครงสร้างภาษา **if–else**
...
หลังจากที่เราเรียนรู้เรื่องพวกนี้ไปแล้วเราจะมาทำ**โปรเจกต์หลักของคอร์สนี้**กัน (course project)
ซึ่งโปรเจกต์นั้นคือ**โปรแกรม Flashcard**
เป็นโปรแกรมไว้ช่วยในการเรียนรู้คำศัพท์ภาษาต่างๆ
หลังจากทำโปรเจกต์นี้แล้ว เราสามารถนำโปรแกรมที่เราสร้างขึ้นมาช่วยในการเรียนรู้เรื่องต่างๆ ในชีิวิตจริงได้ด้วย
...
หลังจากที่เราทำโปรเจกต์ Flashcard จะพบว่า
ถึงแม้เราจะสร้างโปรเจกต์ได้ แต่โค้ดที่เราเขียนไปมีความซ้ำซ้อนมากๆ
...
หลังจากนั้นเราจะมาทำมินิโปรเจกต์ชิ้นสุดท้ายของคอร์สนี้กัน
...
ตัวอย่างเช่น best practice บางอันกล่าวไว้ว่า “เราควรแบ่งโค้ดของเราออกเป็นโมดูลต่างๆ” ซึ่งเป็นคำแนะนำที่มีประโยชน์เมื่อเราทำโปรเจกต์ขนาดใหญ่
...
แต่ถึงคุณไม่ได้ศึกษาในคณะเหล่านี้ คุณสามารถเรียนรู้ได้ด้วยตัวเอง เพราะความรู้พื้นฐานพวกนี้มีอยู่เต็มโลกอินเทอร์เน็ต และคุณแทบไม่ต้องใช้อุปกรณ์หรือเครื่องมือพิเศษเพื่อเรียนรู้สิ่งเหล่านี้เลยครับ
...
**การพิมพ์ดีด** — ในคอร์สเวอร์ชันวิดีโอ ผมจะพิมพ์ทุกอย่างด้วยความเร็วเต็มสปีด ถ้าตามไม่ทันก็สามารถหยุดวิดีโอเพื่อพิมพ์ตามได้
...
**Text editor techniques** — ในคอร์สเวอร์ชันวิดีโอ ผมจะใช้คีย์ลัดต่างๆ เพื่อแก้โค้ดหลายๆ จุดพร้อมๆ กัน
