...
เพราะในภาษา JavaScript ข้อความกับตัวเลข ถือเป็นคนละอย่าง และทำงานไม่เหมือนกัน
(ตัวอย่างเช่น `'1' + '2'` จะได้ผลลัพธ์เป็น `'12'` เพราะข้อความเอามาบวกกัน จะเป็นการต่อกัน ในขณะที่ `1 + 2` จะได้ผลลัพธ์เป็น `3` เพราะเป็นการบวกกันจริงๆ)
...
โดยในคอร์สนี้
เราจะใช้บริการของ Glitch.com ซึ่งเป็นเว็บไซต์ที่ช่วยให้เราสร้างเว็บแอปพลิเคชันได้ง่ายๆ และเร็วๆ ด้วยทุกอย่างทำในเว็บเบราว์เซอร์ ไม่ต้องติดตั้งโปรแกรมอะไรเพิ่มเติม
...
และจะมีแบบฝึกหัดให้ไปลองศึกษา element ต่างๆ ใน HTML เพิ่มเติมด้วยตัวเอง
...
เสร็จแล้วเราจะนำมาสร้างมินิโปรเจคชิ้นต่อไป คือ**โปรแกรมควิซอย่างง่าย** (Simple Quiz)
...
ที่ผู้ใช้งานสามารถกดปุ่ม แล้วโปรแกรมจะตอบกลับมาว่าโยนหัวหรือก้อย
...
ที่ช่วยให้เราสามารถรวมโค้ดหลายๆ บรรทัด มัดรวมกันเป็นชุดคำสั่งที่เราสามารถนำมาใช้ซ้ำได้
...
ตัวอย่างเช่น best practice บางอันกล่าวไว้ว่า “เราควรแยกโค้ดเราเป็นโมดูลต่างๆ” ซึ่งเป็นคำแนะนำที่มีประโยชน์เวลาเราทำโปรเจคใหญ่
แต่สำหรับผู้เริ่มต้น การแยกโค้ดเป็นโมดูล อาจจะทำให้การเห็นภาพการทำงานทั้งหมดของโปรแกรมนั้นยากขึ้น ซึ่งอาจจะเป็นอุปสรรคต่อการเรียนรู้
ดังนั้นอย่าให้ best practices มาขัดความการเรียนรู้ของเราครับ

ในขณะเดียวกัน ก็อยากจะให้พึงระลึกไว้ว่า
พวกท่าต่างๆ ที่เจอในคอร์สนี้ อาจจะไม่ใช้วิธีที่ดีที่สุดเสมอไป และอาจจะถูกแทนที่ด้วยวิธีการเขียนที่ดีกว่า ที่คุณจะได้เรียนรู้ในอนาคตครับ[^pro]
...
คอร์สนี้พยายามที่จะ balance ระหว่าง fundamental knowledge (ความรู้พื้นฐาน) กับ working knowledge (ความรู้ที่ใช้ในการทำงาน) ให้เท่าที่จะทำได้ แต่จะเน้นปฏิบัติเป็นหลัก
...
**การพิมพ์ดีด** — ในคอร์สเวอร์ชันวีดีโอ เพื่อไม่ให้คอร์สใช้เวลานาน ผมจะพิมพ์ทุกอย่างด้วยความเร็วเต็มสปีด ถ้าตามไม่ทันก็สามารถหยุดวีดีโอเพื่อพิมพ์ตามได้
