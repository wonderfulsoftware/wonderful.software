    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'การเขียนโค้ดเพื่อตรวจทานโค้ดของตัวเอง (Automated Testing)',
            link: '/js/automated-testing.html',
          },
        ],
      },
      {
      ...
      {
        text: '6. อาร์เรย์และอ็อบเจกต์',
        items: [
          {
            text: 'รู้จักกับอาร์เรย์',
            link: '/js/array-intro.html',
          },
          {
            text: '🚧 อาร์เรย์ซ้อนอาร์เรย์',
          },
          {
            text: '🚧 วนลูปในอาร์เรย์ด้วย for-of',
          },
          {
            text: '🚧 รู้จักกับอ็อบเจกต์',
          },
          {
            text: '🚧 คำสั่งน่ารู้เพิ่มเติมเกี่ยวกับอาร์เรย์และอ็อบเจกต์',
          },
        ],
      },
      {
        text: '7. เก็บตกความรู้ต่างๆ',
        items: [
          {
          ...
          {
            text: '🚧 ทำงานกับวันที่และเวลา',
          },
          {
            text: '🚧 มินิโปรเจกต์: นาฬิกาบอกเวลา',
          },
          {
            text: '🚧 ลูป while และลูป for',
          },
        ],
      },
      {
