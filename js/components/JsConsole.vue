<template>
  <div class="language-js-console root">
    <pre class="pre"><code class="code-line" v-if="props.input"
    ...
    ><code class="code-line" v-if="props.output"
      ...
      </svg><span><OutputValue :value="props.output?.value" /></span
    ></code
    ><code class="code-line is-error" v-if="props.error"
